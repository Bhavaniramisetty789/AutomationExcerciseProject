...
WebDriver driver;
    ...
    @FindBy (xpath="//*[@id=\"checkoutModal\"]/div/div/div[2]/p[2]/a/u") WebElement ClickonRegister;
	...
	@FindBy (xpath="//ul[@class='nav navbar-nav']/li[10]/a") WebElement Verifylogname;
	@FindBy (xpath="//ul[@class='nav navbar-nav']/li[3]") WebElement clickcart1;
	...
	public void Addtocart() throws InterruptedException
	{
		...
		//Enter Address	
			...
			//To verify Account is created
			 ...
			 if(Verifylogname.isDisplayed()) 
				{
					System.out.println("Logged as:"+"\n"+Verifylogname.getText());
				}
				else 
				{
